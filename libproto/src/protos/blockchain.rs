...
impl<'a> ::std::default::Default for &'a LogBloom {
    fn default() -> &'a LogBloom {
        <LogBloom as ::protobuf::Message>::default_instance()
    }
}
...
impl ::protobuf::Message for LogBloom {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.log_bloom.is_empty() {
            my_size += ::protobuf::rt::bytes_size(1, &self.log_bloom);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        if !self.log_bloom.is_empty() {
            os.write_bytes(1, &self.log_bloom)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "log_bloom",
                    |m: &LogBloom| { &m.log_bloom },
                    |m: &mut LogBloom| { &mut m.log_bloom },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<LogBloom>(
                    "LogBloom",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static LogBloom {
        static mut instance: ::protobuf::lazy::Lazy<LogBloom> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const LogBloom,
        };
        unsafe {
            instance.get(LogBloom::new)
        }
    }
}

impl ::protobuf::Clear for LogBloom {
    fn clear(&mut self) {
        self.log_bloom.clear();
        self.unknown_fields.clear();
    }
...
impl ::protobuf::reflect::ProtobufValue for LogBloom {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
#[derive(PartialEq,Clone,Default)]
pub struct BlockWithLogBloom {
    // message fields
    pub block: ::protobuf::SingularPtrField<Block>,
    pub log_bloom: ::protobuf::SingularPtrField<LogBloom>,
    pub with_txs: bool,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
...
impl<'a> ::std::default::Default for &'a BlockWithLogBloom {
    fn default() -> &'a BlockWithLogBloom {
        <BlockWithLogBloom as ::protobuf::Message>::default_instance()
    }
}

impl BlockWithLogBloom {
    pub fn new() -> BlockWithLogBloom {
        ::std::default::Default::default()
    }
    ...
    pub fn get_log_bloom(&self) -> &LogBloom {
        self.log_bloom.as_ref().unwrap_or_else(|| LogBloom::default_instance())
    }
    pub fn clear_log_bloom(&mut self) {
        self.log_bloom.clear();
    }

    pub fn has_log_bloom(&self) -> bool {
        self.log_bloom.is_some()
    }

    // Param is passed by value, moved
    pub fn set_log_bloom(&mut self, v: LogBloom) {
        self.log_bloom = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_log_bloom(&mut self) -> &mut LogBloom {
        if self.log_bloom.is_none() {
            self.log_bloom.set_default();
        }
        self.log_bloom.as_mut().unwrap()
    }

    // Take field
    pub fn take_log_bloom(&mut self) -> LogBloom {
        self.log_bloom.take().unwrap_or_else(|| LogBloom::new())
    }

    // bool with_txs = 3;


    pub fn get_with_txs(&self) -> bool {
        self.with_txs
    }
    pub fn clear_with_txs(&mut self) {
        self.with_txs = false;
    }

    // Param is passed by value, moved
    pub fn set_with_txs(&mut self, v: bool) {
        self.with_txs = v;
    }
}

impl ::protobuf::Message for BlockWithLogBloom {
    fn is_initialized(&self) -> bool {
        for v in &self.block {
            if !v.is_initialized() {
                return false;
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.log_bloom)?;
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.log_bloom.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        if self.with_txs != false {
            my_size += 2;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
    ...
    fn new() -> BlockWithLogBloom {
        BlockWithLogBloom::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<Block>>(
                    "block",
                    |m: &BlockWithLogBloom| { &m.block },
                    |m: &mut BlockWithLogBloom| { &mut m.block },
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<LogBloom>>(
                    "log_bloom",
                    |m: &BlockWithLogBloom| { &m.log_bloom },
                    |m: &mut BlockWithLogBloom| { &mut m.log_bloom },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                    "with_txs",
                    |m: &BlockWithLogBloom| { &m.with_txs },
                    |m: &mut BlockWithLogBloom| { &mut m.with_txs },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<BlockWithLogBloom>(
                    "BlockWithLogBloom",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static BlockWithLogBloom {
        static mut instance: ::protobuf::lazy::Lazy<BlockWithLogBloom> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const BlockWithLogBloom,
        };
        unsafe {
            instance.get(BlockWithLogBloom::new)
        }
    }
}

impl ::protobuf::Clear for BlockWithLogBloom {
    fn clear(&mut self) {
        self.block.clear();
        self.log_bloom.clear();
        self.with_txs = false;
...
impl ::std::fmt::Debug for BlockWithLogBloom {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for BlockWithLogBloom {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
#[derive(PartialEq,Clone,Default)]
pub struct ChainVersionReq {
    // message fields
    pub soft_version: ::std::string::String,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}

impl<'a> ::std::default::Default for &'a ChainVersionReq {
    fn default() -> &'a ChainVersionReq {
        <ChainVersionReq as ::protobuf::Message>::default_instance()
    }
}

impl ChainVersionReq {
    pub fn new() -> ChainVersionReq {
        ::std::default::Default::default()
    }
    ...
    pub fn get_soft_version(&self) -> &str {
        &self.soft_version
    }
    pub fn clear_soft_version(&mut self) {
        self.soft_version.clear();
    }

    // Param is passed by value, moved
    pub fn set_soft_version(&mut self, v: ::std::string::String) {
        self.soft_version = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_soft_version(&mut self) -> &mut ::std::string::String {
        &mut self.soft_version
    }

    // Take field
    pub fn take_soft_version(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.soft_version, ::std::string::String::new())
    }
}

impl ::protobuf::Message for ChainVersionReq {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.soft_version)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.soft_version.is_empty() {
            my_size += ::protobuf::rt::string_size(1, &self.soft_version);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        if !self.soft_version.is_empty() {
            os.write_string(1, &self.soft_version)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "soft_version",
                    |m: &ChainVersionReq| { &m.soft_version },
                    |m: &mut ChainVersionReq| { &mut m.soft_version },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<ChainVersionReq>(
                    "ChainVersionReq",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static ChainVersionReq {
        static mut instance: ::protobuf::lazy::Lazy<ChainVersionReq> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ChainVersionReq,
        };
        unsafe {
            instance.get(ChainVersionReq::new)
        }
    }
}

impl ::protobuf::Clear for ChainVersionReq {
    fn clear(&mut self) {
        self.soft_version.clear();
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for ChainVersionReq {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ChainVersionReq {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
impl<'a> ::std::default::Default for &'a ChainVersionResp {
    fn default() -> &'a ChainVersionResp {
        <ChainVersionResp as ::protobuf::Message>::default_instance()
    }
}

impl ChainVersionResp {
    pub fn new() -> ChainVersionResp {
        ::std::default::Default::default()
    }
...
impl ::protobuf::Message for ChainVersionResp {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn new() -> ChainVersionResp {
        ChainVersionResp::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "soft_version",
                    |m: &ChainVersionResp| { &m.soft_version },
                    |m: &mut ChainVersionResp| { &mut m.soft_version },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<ChainVersionResp>(
                    "ChainVersionResp",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static ChainVersionResp {
        static mut instance: ::protobuf::lazy::Lazy<ChainVersionResp> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ChainVersionResp,
        };
        unsafe {
            instance.get(ChainVersionResp::new)
        }
    }
}

impl ::protobuf::Clear for ChainVersionResp {
    fn clear(&mut self) {
        self.soft_version.clear();
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for ChainVersionResp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ChainVersionResp {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
impl<'a> ::std::default::Default for &'a PoolTxNum {
    fn default() -> &'a PoolTxNum {
        <PoolTxNum as ::protobuf::Message>::default_instance()
    }
}

impl PoolTxNum {
    pub fn new() -> PoolTxNum {
        ::std::default::Default::default()
    }
...
impl ::protobuf::Message for PoolTxNum {
    fn is_initialized(&self) -> bool {
        true
    }
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "num",
                    |m: &PoolTxNum| { &m.num },
                    |m: &mut PoolTxNum| { &mut m.num },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<PoolTxNum>(
                    "PoolTxNum",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static PoolTxNum {
        static mut instance: ::protobuf::lazy::Lazy<PoolTxNum> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const PoolTxNum,
        };
        unsafe {
            instance.get(PoolTxNum::new)
        }
    }
}

impl ::protobuf::Clear for PoolTxNum {
    fn clear(&mut self) {
        self.num = 0;
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for PoolTxNum {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for PoolTxNum {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x1b\n\tlog_bloom\x18\x01\x20\x01(\x0cR\x08logBloom\"t\n\x11BlockWit\
    hLogBloom\x12\x1c\n\x05block\x18\x01\x20\x01(\x0b2\x06.BlockR\x05block\
    \x12&\n\tlog_bloom\x18\x02\x20\x01(\x0b2\t.LogBloomR\x08logBloom\x12\x19\
    \n\x08with_txs\x18\x03\x20\x01(\x08R\x07withTxs\"4\n\x0fChainVersionReq\
    \x12!\n\x0csoft_version\x18\x01\x20\x01(\tR\x0bsoftVersion\"5\n\x10Chain\
    VersionResp\x12!\n\x0csoft_version\x18\x01\x20\x01(\tR\x0bsoftVersion\"\
    \x1d\n\tPoolTxNum\x12\x10\n\x03num\x18\x01\x20\x01(\x04R\x03num*2\n\tPro\
    ofType\x12\x12\n\x0eAuthorityRound\x10\0\x12\x08\n\x04Raft\x10\x01\x12\
    \x07\n\x03Bft\x10\x02*#\n\x06Crypto\x12\x0b\n\x07DEFAULT\x10\0\x12\x0c\n\
    \x08RESERVED\x10\x01J\xa4)\n\x07\x12\x05\0\0\x8e\x01\x01\n\x08\n\x01\x0c\
    \x12\x03\0\0\x12\n\n\n\x02\x05\0\x12\x04\x02\0\x06\x01\n\n\n\x03\x05\0\
    \x01\x12\x03\x02\x05\x0e\n\x0b\n\x04\x05\0\x02\0\x12\x03\x03\x04\x17\n\
    ...
    \x01\x12\x03\x14\x0b\x15\n\x0c\n\x05\x04\x01\x02\x06\x03\x12\x03\x14\x18\
    \x19\n\x0b\n\x04\x04\x01\x02\x07\x12\x03\x15\x04\x1b\n\r\n\x05\x04\x01\
    \x02\x07\x04\x12\x04\x15\x04\x14\x1a\n\x0c\n\x05\x04\x01\x02\x07\x05\x12\
    ...
    \x02\x06\x12\x03+\x04\x19\n\r\n\x05\x04\x04\x02\x06\x04\x12\x04+\x04*\"\
    ...
    \x02\x12\x036\x04\x15\n\r\n\x05\x04\x05\x02\x02\x04\x12\x046\x045\x15\n\
    \x0c\n\x05\x04\x05\x02\x02\x05\x12\x036\x04\n\n\x0c\n\x05\x04\x05\x02\
    \x02\x01\x12\x036\x0b\x10\n\x0c\n\x05\x04\x05\x02\x02\x03\x12\x036\x13\
    ...
    \x03B\x04\x18\n\r\n\x05\x04\x06\x02\x01\x04\x12\x04B\x04A\x20\n\x0c\n\
    ...
    \x0c\x02\x01\x04\x12\x04f\x04e\x12\n\x0c\n\x05\x04\x0c\x02\x01\x06\x12\
    \x03f\x04\t\n\x0c\n\x05\x04\x0c\x02\x01\x01\x12\x03f\n\x0f\n\x0c\n\x05\
    \x04\x0c\x02\x01\x03\x12\x03f\x12\x13\n\n\n\x02\x04\r\x12\x04i\0l\x01\n\
