...
pub struct InitMessage {
    ...
    pub node_cert_chain: ::protobuf::RepeatedField<::std::vec::Vec<u8>>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}

impl<'a> ::std::default::Default for &'a InitMessage {
    fn default() -> &'a InitMessage {
        <InitMessage as ::protobuf::Message>::default_instance()
    }
}

impl InitMessage {
    pub fn new() -> InitMessage {
        ::std::default::Default::default()
    }
    ...
    pub fn get_peer_key(&self) -> &[u8] {
        &self.peer_key
    }
    pub fn clear_peer_key(&mut self) {
        self.peer_key.clear();
    }

    // Param is passed by value, moved
    pub fn set_peer_key(&mut self, v: ::std::vec::Vec<u8>) {
        self.peer_key = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_peer_key(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.peer_key
    }

    // Take field
    pub fn take_peer_key(&mut self) -> ::std::vec::Vec<u8> {
        ::std::mem::replace(&mut self.peer_key, ::std::vec::Vec::new())
    }

    // repeated bytes node_cert_chain = 3;


    pub fn get_node_cert_chain(&self) -> &[::std::vec::Vec<u8>] {
        &self.node_cert_chain
    }
    pub fn clear_node_cert_chain(&mut self) {
        self.node_cert_chain.clear();
    }

    // Param is passed by value, moved
    pub fn set_node_cert_chain(&mut self, v: ::protobuf::RepeatedField<::std::vec::Vec<u8>>) {
        self.node_cert_chain = v;
    }

    // Mutable pointer to the field.
    pub fn mut_node_cert_chain(&mut self) -> &mut ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        &mut self.node_cert_chain
    }

    // Take field
    pub fn take_node_cert_chain(&mut self) -> ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        ::std::mem::replace(&mut self.node_cert_chain, ::protobuf::RepeatedField::new())
    }
}

impl ::protobuf::Message for InitMessage {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.peer_key)?;
                },
                3 => {
                    ::protobuf::rt::read_repeated_bytes_into(wire_type, is, &mut self.node_cert_chain)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.peer_key.is_empty() {
            my_size += ::protobuf::rt::bytes_size(2, &self.peer_key);
        }
        for value in &self.node_cert_chain {
            my_size += ::protobuf::rt::bytes_size(3, &value);
        };
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.peer_key.is_empty() {
            os.write_bytes(2, &self.peer_key)?;
        }
        for v in &self.node_cert_chain {
            os.write_bytes(3, &v)?;
        };
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "chain_id",
                    |m: &InitMessage| { &m.chain_id },
                    |m: &mut InitMessage| { &mut m.chain_id },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "peer_key",
                    |m: &InitMessage| { &m.peer_key },
                    |m: &mut InitMessage| { &mut m.peer_key },
                ));
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "node_cert_chain",
                    |m: &InitMessage| { &m.node_cert_chain },
                    |m: &mut InitMessage| { &mut m.node_cert_chain },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<InitMessage>(
                    "InitMessage",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static InitMessage {
        static mut instance: ::protobuf::lazy::Lazy<InitMessage> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const InitMessage,
        };
        unsafe {
            instance.get(InitMessage::new)
        }
    }
}

impl ::protobuf::Clear for InitMessage {
    fn clear(&mut self) {
        self.chain_id = 0;
        self.peer_key.clear();
        self.node_cert_chain.clear();
...
impl ::protobuf::reflect::ProtobufValue for InitMessage {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\