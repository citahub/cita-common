...
pub enum Request_oneof_req {
    ...
    light_block_by_hash(::std::vec::Vec<u8>),
    light_block_by_number(::std::vec::Vec<u8>),
}
...
impl Request {
    ...
    pub fn get_light_call(&self) -> &Call {
        match self.req {
            ::std::option::Option::Some(Request_oneof_req::light_call(ref v)) => v,
            _ => Call::default_instance(),
        }
    }
    ...
    pub fn has_light_call(&self) -> bool {
        match self.req {
            ::std::option::Option::Some(Request_oneof_req::light_call(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_light_call(&mut self, v: Call) {
        self.req = ::std::option::Option::Some(Request_oneof_req::light_call(v))
    }

    // Mutable pointer to the field.
    pub fn mut_light_call(&mut self) -> &mut Call {
        if let ::std::option::Option::Some(Request_oneof_req::light_call(_)) = self.req {
        } else {
            self.req = ::std::option::Option::Some(Request_oneof_req::light_call(Call::new()));
        }
        match self.req {
            ::std::option::Option::Some(Request_oneof_req::light_call(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_light_call(&mut self) -> Call {
        if self.has_light_call() {
            match self.req.take() {
                ::std::option::Option::Some(Request_oneof_req::light_call(v)) => v,
                _ => panic!(),
            }
        } else {
            Call::new()
    ...
    // bytes light_block_by_hash = 35;


    pub fn get_light_block_by_hash(&self) -> &[u8] {
        match self.req {
    ...
    // Param is passed by value, moved
    pub fn set_light_block_by_hash(&mut self, v: ::std::vec::Vec<u8>) {
        self.req = ::std::option::Option::Some(Request_oneof_req::light_block_by_hash(v))
    }

    // Mutable pointer to the field.
    pub fn mut_light_block_by_hash(&mut self) -> &mut ::std::vec::Vec<u8> {
        if let ::std::option::Option::Some(Request_oneof_req::light_block_by_hash(_)) = self.req {
        } else {
            self.req = ::std::option::Option::Some(Request_oneof_req::light_block_by_hash(::std::vec::Vec::new()));
        }
        match self.req {
    ...
    // Take field
    pub fn take_light_block_by_hash(&mut self) -> ::std::vec::Vec<u8> {
    ...
    // bytes light_block_by_number = 36;


    pub fn get_light_block_by_number(&self) -> &[u8] {
        match self.req {
            ::std::option::Option::Some(Request_oneof_req::light_block_by_number(ref v)) => v,
            _ => &[],
        }
    }
    pub fn clear_light_block_by_number(&mut self) {
        self.req = ::std::option::Option::None;
    }

    pub fn has_light_block_by_number(&self) -> bool {
        match self.req {
            ::std::option::Option::Some(Request_oneof_req::light_block_by_number(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_light_block_by_number(&mut self, v: ::std::vec::Vec<u8>) {
        self.req = ::std::option::Option::Some(Request_oneof_req::light_block_by_number(v))
    }

    // Mutable pointer to the field.
    pub fn mut_light_block_by_number(&mut self) -> &mut ::std::vec::Vec<u8> {
        if let ::std::option::Option::Some(Request_oneof_req::light_block_by_number(_)) = self.req {
        } else {
            self.req = ::std::option::Option::Some(Request_oneof_req::light_block_by_number(::std::vec::Vec::new()));
        }
        match self.req {
            ::std::option::Option::Some(Request_oneof_req::light_block_by_number(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_light_block_by_number(&mut self) -> ::std::vec::Vec<u8> {
        if self.has_light_block_by_number() {
            match self.req.take() {
                ::std::option::Option::Some(Request_oneof_req::light_block_by_number(v)) => v,
                _ => panic!(),
            }
        } else {
            ::std::vec::Vec::new()
...
impl ::protobuf::Message for Request {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(Request_oneof_req::light_call(ref v)) = self.req {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                32 => {
                    ...
                    self.req = ::std::option::Option::Some(Request_oneof_req::light_call(is.read_message()?));
                },
                33 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                35 => {
                    ...
                    self.req = ::std::option::Option::Some(Request_oneof_req::light_block_by_hash(is.read_bytes()?));
                },
                36 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.req = ::std::option::Option::Some(Request_oneof_req::light_block_by_number(is.read_bytes()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.req {
            match v {
                ...
                &Request_oneof_req::light_call(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
                ...
                &Request_oneof_req::light_block_by_number(ref v) => {
                    my_size += ::protobuf::rt::bytes_size(36, &v);
                },
            };
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, Call>(
                    "light_call",
                    Request::has_light_call,
                    Request::get_light_call,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_bytes_accessor::<_>(
                    "light_code",
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_bytes_accessor::<_>(
                    "light_block_by_number",
                    Request::has_light_block_by_number,
                    Request::get_light_block_by_number,
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x03\x20\x01(\tR\x06height\"\x93\x0b\n\x07Request\x12\x1d\n\nrequest_id\
    ...
    \x18\x20\x20\x01(\x0b2\x05.CallH\0R\tlightCall\x12\x1f\n\nlight_code\x18\
    !\x20\x01(\x0cH\0R\tlightCode\x12\x1d\n\tlight_abi\x18\"\x20\x01(\x0cH\0\
    R\x08lightAbi\x12/\n\x13light_block_by_hash\x18#\x20\x01(\x0cH\0R\x10lig\
    htBlockByHash\x123\n\x15light_block_by_number\x18$\x20\x01(\x0cH\0R\x12l\
    ightBlockByNumberB\x05\n\x03req\"@\n\x0cBatchRequest\x120\n\x0fnew_tx_re\
    quests\x18\x01\x20\x03(\x0b2\x08.RequestR\rnewTxRequests*1\n\x08BlockTag\
    \x12\n\n\x06Latest\x10\0\x12\x0c\n\x08Earliest\x10\x01\x12\x0b\n\x07Pend\
    ing\x10\x02J\xe9\x18\n\x06\x12\x04\0\0J\x01\n\x08\n\x01\x0c\x12\x03\0\0\
    ...
    \x18\n\x0c\n\x04\x04\x03\x08\0\x12\x04\x1f\x04E\x05\n\x0c\n\x05\x04\x03\
    ...
    \x12\x03?*,\n\x0b\n\x04\x04\x03\x02\x1f\x12\x03@\x08\x1d\n\x0c\n\x05\x04\
    \x03\x02\x1f\x06\x12\x03@\x08\x0c\n\x0c\n\x05\x04\x03\x02\x1f\x01\x12\
    \x03@\r\x17\n\x0c\n\x05\x04\x03\x02\x1f\x03\x12\x03@\x1a\x1c\n\x0b\n\x04\
    \x04\x03\x02\x20\x12\x03A\x08\x1e\n\x0c\n\x05\x04\x03\x02\x20\x05\x12\
    \x03A\x08\r\n\x0c\n\x05\x04\x03\x02\x20\x01\x12\x03A\x0e\x18\n\x0c\n\x05\
    \x04\x03\x02\x20\x03\x12\x03A\x1b\x1d\n\x0b\n\x04\x04\x03\x02!\x12\x03B\
    \x08\x1d\n\x0c\n\x05\x04\x03\x02!\x05\x12\x03B\x08\r\n\x0c\n\x05\x04\x03\
    \x02!\x01\x12\x03B\x0e\x17\n\x0c\n\x05\x04\x03\x02!\x03\x12\x03B\x1a\x1c\
    \n\x0b\n\x04\x04\x03\x02\"\x12\x03C\x08'\n\x0c\n\x05\x04\x03\x02\"\x05\
    \x12\x03C\x08\r\n\x0c\n\x05\x04\x03\x02\"\x01\x12\x03C\x0e!\n\x0c\n\x05\
    \x04\x03\x02\"\x03\x12\x03C$&\n\x0b\n\x04\x04\x03\x02#\x12\x03D\x08)\n\
    \x0c\n\x05\x04\x03\x02#\x05\x12\x03D\x08\r\n\x0c\n\x05\x04\x03\x02#\x01\
    \x12\x03D\x0e#\n\x0c\n\x05\x04\x03\x02#\x03\x12\x03D&(\n\n\n\x02\x04\x04\
    \x12\x04H\0J\x01\n\n\n\x03\x04\x04\x01\x12\x03H\x08\x14\n\x0b\n\x04\x04\
    \x04\x02\0\x12\x03I\x04)\n\x0c\n\x05\x04\x04\x02\0\x04\x12\x03I\x04\x0c\
