...
pub enum InnerMessage_oneof_content {
    ...
    ChainVersionReq(super::blockchain::ChainVersionReq),
    ChainVersionResp(super::blockchain::ChainVersionResp),
}
...
impl InnerMessage {
    ...
    pub fn get_ChainVersionReq(&self) -> &super::blockchain::ChainVersionReq {
        match self.content {
            ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionReq(ref v)) => v,
            _ => super::blockchain::ChainVersionReq::default_instance(),
        }
    }
    pub fn clear_ChainVersionReq(&mut self) {
        self.content = ::std::option::Option::None;
    }

    pub fn has_ChainVersionReq(&self) -> bool {
        match self.content {
            ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionReq(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_ChainVersionReq(&mut self, v: super::blockchain::ChainVersionReq) {
        self.content = ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionReq(v))
    }

    // Mutable pointer to the field.
    pub fn mut_ChainVersionReq(&mut self) -> &mut super::blockchain::ChainVersionReq {
        if let ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionReq(_)) = self.content {
        } else {
            self.content = ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionReq(super::blockchain::ChainVersionReq::new()));
        }
        match self.content {
            ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionReq(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_ChainVersionReq(&mut self) -> super::blockchain::ChainVersionReq {
        if self.has_ChainVersionReq() {
            match self.content.take() {
                ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionReq(v)) => v,
                _ => panic!(),
            }
        } else {
            super::blockchain::ChainVersionReq::new()
        }
    }
    ...
    pub fn get_ChainVersionResp(&self) -> &super::blockchain::ChainVersionResp {
        match self.content {
            ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionResp(ref v)) => v,
            _ => super::blockchain::ChainVersionResp::default_instance(),
        }
    }
    pub fn clear_ChainVersionResp(&mut self) {
        self.content = ::std::option::Option::None;
    }

    pub fn has_ChainVersionResp(&self) -> bool {
        match self.content {
            ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionResp(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_ChainVersionResp(&mut self, v: super::blockchain::ChainVersionResp) {
        self.content = ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionResp(v))
    }

    // Mutable pointer to the field.
    pub fn mut_ChainVersionResp(&mut self) -> &mut super::blockchain::ChainVersionResp {
        if let ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionResp(_)) = self.content {
        } else {
            self.content = ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionResp(super::blockchain::ChainVersionResp::new()));
        }
        match self.content {
            ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionResp(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_ChainVersionResp(&mut self) -> super::blockchain::ChainVersionResp {
        if self.has_ChainVersionResp() {
            match self.content.take() {
                ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionResp(v)) => v,
                _ => panic!(),
            }
        } else {
            super::blockchain::ChainVersionResp::new()
        }
    }
}
...
impl ::protobuf::Message for InnerMessage {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(InnerMessage_oneof_content::ChainVersionReq(ref v)) = self.content {
            if !v.is_initialized() {
                return false;
            }
        }
        if let Some(InnerMessage_oneof_content::ChainVersionResp(ref v)) = self.content {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                42 => {
                    ...
                    self.content = ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionReq(is.read_message()?));
                },
                43 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.content = ::std::option::Option::Some(InnerMessage_oneof_content::ChainVersionResp(is.read_message()?));
                },
                _ => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.content {
            match v {
                ...
                &InnerMessage_oneof_content::ChainVersionReq(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
                &InnerMessage_oneof_content::ChainVersionResp(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
            };
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, super::blockchain::ChainVersionReq>(
                    "ChainVersionReq",
                    InnerMessage::has_ChainVersionReq,
                    InnerMessage::get_ChainVersionReq,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, super::blockchain::ChainVersionResp>(
                    "ChainVersionResp",
                    InnerMessage::has_ChainVersionResp,
                    InnerMessage::get_ChainVersionResp,
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    (\x0b2\x12.BlockWithLogBloomH\0R\x11BlockWithLogBloom\x12<\n\x0fChainVer\
    sionReq\x18*\x20\x01(\x0b2\x10.ChainVersionReqH\0R\x0fChainVersionReq\
    \x12?\n\x10ChainVersionResp\x18+\x20\x01(\x0b2\x11.ChainVersionRespH\0R\
    \x10ChainVersionRespB\t\n\x07contentJ\xf8\x12\n\x06\x12\x04\0\0M\x01\n\
    ...
    \x07\x1c\n\n\n\x02\x04\0\x12\x04\x0c\0M\x01\n\n\n\x03\x04\0\x01\x12\x03\
    \x0c\x08\x14\n\x0c\n\x04\x04\0\x08\0\x12\x04\x0e\x04L\x05\n\x0c\n\x05\
    \x04\0\x08\0\x01\x12\x03\x0e\n\x11\n\x0b\n\x04\x04\0\x02\0\x12\x03\x10\
    \x08\x1b\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03\x10\x08\r\n\x0c\n\x05\x04\0\
    \x02\0\x01\x12\x03\x10\x0e\x16\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03\x10\
    \x19\x1a\n\x0b\n\x04\x04\0\x02\x01\x12\x03\x12\x08\x1c\n\x0c\n\x05\x04\0\
    \x02\x01\x06\x12\x03\x12\x08\x0f\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03