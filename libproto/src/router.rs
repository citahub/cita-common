    ...
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(
            ...
            match self {
                ...
                &MsgType::ReceiptsResponse => "receipts_response",
                &MsgType::TrieResponse => "trie_response",
                &MsgType::CodeRespond => "code_respond",
                &MsgType::AbiRespond => "abi_respond",
...
impl<'a> From<&'a str> for MsgType {
    fn from(s: &'a str) -> MsgType {
        match s {
            ...
            "receipts_response" => MsgType::ReceiptsResponse,
            "trie_response" => MsgType::TrieResponse,
            "code_respond" => MsgType::CodeRespond,
            "abi_respond" => MsgType::AbiRespond,
