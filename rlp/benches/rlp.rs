...
fn bench_stream_u64_value(c: &mut Criterion) {
    c.bench_function("bench_stream_u64_value", |b| {
        b.iter(|| {
            // u64
...
fn bench_decode_u64_value(c: &mut Criterion) {
    c.bench_function("bench_decode_u64_value", |b| {
        b.iter(|| {
            // u64
...
fn bench_stream_u256_value(c: &mut Criterion) {
    c.bench_function("bench_stream_u256_value", |b| {
        b.iter(|| {
            // u256
            let mut stream = RlpStream::new();
...
fn bench_decode_u256_value(c: &mut Criterion) {
    c.bench_function("bench_decode_u256_value", |b| {
        b.iter(|| {
            // u256
            let data = vec![
...
fn bench_stream_nested_empty_lists(c: &mut Criterion) {
    c.bench_function("bench_stream_nested_empty_lists", |b| {
        b.iter(|| {
            // [ [], [[]], [ [], [[]] ] ]
...
fn bench_decode_nested_empty_lists(c: &mut Criterion) {
    c.bench_function("bench_decode_nested_empty_lists", |b| {
        b.iter(|| {
            // [ [], [[]], [ [], [[]] ] ]
...
fn bench_stream_1000_empty_lists(c: &mut Criterion) {
    c.bench_function("bench_stream_1000_empty_lists", |b| {
        b.iter(|| {
